...
pg.mixer.init()
pg.mixer.music.load(r"C:\Users\ADMIN\Desktop\uni\Project1_Pygame\workshop1_pygame_2025-171879-17555328720526\workshop1-2025\source\sound.mp3")
pg.mixer.music.play(-1, 0.0)

# ใช้คำสั่ง soundeffect.play() เพื่อเล่นเสียง effect ตอนลูกบอลชนกัน
soundeffect = pg.mixer.Sound(r"C:\Users\ADMIN\Desktop\uni\Project1_Pygame\workshop1_pygame_2025-171879-17555328720526\workshop1-2025\source\effect.wav")
...
ball1_img = pg.image.load(r"C:\Users\ADMIN\Desktop\uni\Project1_Pygame\workshop1_pygame_2025-171879-17555328720526\workshop1-2025\source\BNK48\Wee_cc.png").convert_alpha()
...
ball2_img = pg.image.load(r"C:\Users\ADMIN\Desktop\uni\Project1_Pygame\workshop1_pygame_2025-171879-17555328720526\workshop1-2025\source\BNK48\Cherprang_cc.png").convert_alpha()
...
ball3_img = pg.image.load(r"C:\Users\ADMIN\Desktop\uni\Project1_Pygame\workshop1_pygame_2025-171879-17555328720526\workshop1-2025\source\BNK48\Pun_cc.png").convert_alpha()
ball3_img = pg.transform.scale(ball3_img, (120, 120))
ball3_rect = ball3_img.get_rect(center=(800,400))


# ฟังก์ชันสำหรับเช็คว่าลูกบอล 2 ลูกชนกันหรือไม่ (เทียบระยะห่างจากจุดศูนย์กลางกับผลรวมของรัศมี)
# ถ้าชนกัน ให้สลับทิศทางความเร็วของทั้งคู่ (bounce) และเล่นเสียง effect -> ใช้ตอบ TODO 15
def check_ball_collision(rect1, speed1, rect2, speed2):
    dx = rect1.centerx - rect2.centerx
    dy = rect1.centery - rect2.centery
    distance = math.hypot(dx, dy)
    min_distance = rect1.width / 2 + rect2.width / 2

    if distance < min_distance:
        speed1[0], speed1[1] = -speed1[0], -speed1[1]
        speed2[0], speed2[1] = -speed2[0], -speed2[1]
        soundeffect.play()
        return True
    return False
...
while running:
    ...
    if running:
        ...
        font = pg.font.Font(font_name, 130)  # กำหนดขนาด font
        title_surface = font.render("Heavy Collision", True, white)
        ...
        text_surface = font.render("6932273321", True, white)  # TODO: เปลี่ยนเป็นรหัสนิสิตของคุณ
        ...
        if check_ball_collision(ball1_rect, ball1_speed, ball2_rect, ball2_speed):
            ball1_rect = ball1_rect.move(ball1_speed)
            ball2_rect = ball2_rect.move(ball2_speed)

        if check_ball_collision(ball1_rect, ball1_speed, ball3_rect, ball3_speed):
            ball1_rect = ball1_rect.move(ball1_speed)
            ball3_rect = ball3_rect.move(ball3_speed)

        if check_ball_collision(ball2_rect, ball2_speed, ball3_rect, ball3_speed):
            ball2_rect = ball2_rect.move(ball2_speed)
            ball3_rect = ball3_rect.move(ball3_speed)
